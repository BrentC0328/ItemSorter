...
public class SortByPriceTest {
    ...
    public void test1() {
        // given
        Item item3 = new Item(0L, "Apple", 5.1);
        Item item2 = new Item(1L, "Banana", 2.0);
        Item item1 = new Item(2L, "Cherry", 3.8);
    ...
    public void test2() {
        ...
        Item item2 = new Item(4L, "Banana", 1.75);
        Item item1 = new Item(5L, "Cherry", 21.0);
        Item[] itemsToSort = {item2, item1, item3};
        Item[] expected = {item3, item2, item1};
        ItemSorter itemSorter = new ItemSorter(itemsToSort);
        Comparator<Item> comparator = (Comparator<Item>) new IdComparator();
    ...
    public void test3() {
        ...
        Item item2 = new Item(15L, "Banana", 20.0);
